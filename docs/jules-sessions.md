...
|---|------|------------|-----|--------|
| 01 | jules-task-01-collect-cli | `11230661329440855055` | `jules/task01-01-collect-cli-*` | влито в feature/1106 |
| 02 | jules-task-02-browser-session | `1933286480438032048` | `jules/task01-02-browser-*` | влито |
| 03 | jules-task-03-sberbank-search | `6576030339391965229` | `jules/task01-03-sber-search` | создана |
